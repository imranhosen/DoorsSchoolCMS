...
namespace App\Http\Controllers\Voyager\subjects;
...
class SubjectController extends VoyagerBaseController
{
    public function index(Request $request)
    {
        ...
        if(($user->role_id) == $role){
            ...
            $subjectNames = Subject::whereIn('id', $subjectId)->orderBy('id','DESC')->get('name');
            return view('vendor.voyager.subjects.subject-by-user',compact('subjectNames','className','students'));
        }
