...
namespace App\Http\Controllers\Voyager\exam_marks;
...
class MarkController extends VoyagerBaseController
{
    public function index(Request $request)
    {
        ...
        if(($user->role_id) == $role_id){
            ...
            $student_marks = ExamMark::where('student_id',$user->student_id)->orderBy('id','DESC')->get();
            ...
            return view('vendor.voyager.exam-marks.marks-by-user',compact('subjectNames','className','student_marks'));
        }
