    ...
    @foreach($vice_principle as $prin)
        <div class="container spacet50 spaceb50">
            <div class="row">
                ...
                <div class="col-md-12">
                    <p style="margin-left: 240px"><img width="700" height="800" class="round5"
                    ...
                    <table border="0" cellpadding="5" cellspacing="5" font-size:="" helvetica="" style="border-spacing: 0px; border-collapse: collapse; font-family: " width="100%">
                        ...
                        <tr style="box-sizing: border-box;">
                            <td style="box-sizing: border-box; padding: 0px; text-align: justify; text-align: center; font-size: large">সহকারি প্রধান</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
