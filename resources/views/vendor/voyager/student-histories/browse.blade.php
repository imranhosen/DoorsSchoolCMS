...
@section('content')
    <div class="page-content browse container-fluid">
        <div class="container mt-4">
            ...
            <div class="form-group col-md-12" id="studentHistoryDiv1">
                <h4><i class="voyager-group"></i>  Student History</h4>
                <hr>
            ...
            <div class="form-group col-md-12" hidden="hidden" id="studentHistoryDiv2">
                <h4><i class="voyager-group"></i>  Student History</h4>
                <hr>
