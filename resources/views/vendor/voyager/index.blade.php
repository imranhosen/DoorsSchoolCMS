                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage"
                        ...
                        <div class="panel-content">
                            <i class="voyager-group"></i><h4>{{\App\Models\Student::all()->count()}} Student</h4>
                            <p>We have {{\App\Models\Student::all()->count()}} Students in our institute.
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage" style="margin-bottom:0;overflow:hidden;
            /*background-image:url('http://127.0.0.1:8000/admin/voyager-assets?path=images%2Fwidget-backgrounds%2F02.jpg');*/">
                        <div class="dimmer"></div>
                        <div class="panel-content">
                            <i class="voyager-group"></i><h4>{{\App\Models\Staff::all()->count()}} Staff</h4>
                            <p>We have {{\App\Models\Staff::all()->count()}} staffs in our institute.
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage" style="margin-bottom:0;overflow:hidden;
            /*background-image:url('http://127.0.0.1:8000/admin/voyager-assets?path=images%2Fwidget-backgrounds%2F03.jpg');*/">
                        <div class="dimmer"></div>
                        <div class="panel-content">
                            <i class="voyager-group"></i><h4>{{\App\Models\Staff::where('role_id', 8)->count()}}
                                Teacher</h4>
                            <p>We have {{\App\Models\Staff::where('role_id', 8)->count()}} Teacher in our institute.
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage"
                        ...
                        <div class="panel-content">
                            ...
                            <h4>{{\App\Models\Staff::where('library_id', '!=' ,null)->count()+\App\Models\Student::where('library_id', '!=' ,null)->count()}}
                                Library Member</h4>
                            <p>We have
                                total {{\App\Models\Staff::where('library_id', '!=' ,null)->count()+\App\Models\Student::where('library_id', '!=' ,null)->count()}}
                                Library Member in our institute.
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage"
                        ...
                        <div class="dimmer"></div>
                        <div class="panel-content">
                            <i class="voyager-book"></i><h4>{{\App\Models\Book::all()->count()}} Book</h4>
                            <p>We have {{\App\Models\Book::all()->count()}} books in our library.
                        </div>
                    </div>
                </div>
                <div class="panel widget center bgimage"
                    ...
                    <div class="dimmer"></div>
                    <div class="panel-content">
                        <i class="voyager-group"></i><h4>Today Student Present {{$today_present_student}}</h4>
                        <p>Today total {{$today_present_student}} students are present in your institute.
                    </div>
                </div>
            </div>
        @else
            <div class="clearfix container-fluid row">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage"
                        ...
                        <div class="panel-content">
                            <i class="voyager-group"></i><h4>{{\App\Models\Student::all()->count()}} Student</h4>
                            <p>You have {{\App\Models\Student::all()->count()}} Students in your database. Click on
                                button
                                below to view all Students.</p>
                            <a href="{{route('voyager.students.index')}}" class="btn btn-primary">View all Students</a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            /*background-image:url('http://127.0.0.1:8000/admin/voyager-assets?path=images%2Fwidget-backgrounds%2F02.jpg');*/">
                        ...
                        <div class="panel-content">
                            <i class="voyager-group"></i><h4>{{\App\Models\Staff::all()->count()}} Staff</h4>
                            <p>You have {{\App\Models\Staff::all()->count()}} staffs in your database. Click on button
                                below to view all Staffs.</p>
                            <a href="{{route('staffDirectoryIndex')}}" class="btn btn-primary">View all Staffs</a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            /*background-image:url('http://127.0.0.1:8000/admin/voyager-assets?path=images%2Fwidget-backgrounds%2F03.jpg');*/">
                        ...
                        <div class="panel-content">
                            <i class="voyager-group"></i><h4>{{\App\Models\Staff::where('role_id', 8)->count()}}
                                Teacher</h4>
                            <p>You have {{\App\Models\Staff::where('role_id', 8)->count()}} Teacher in your database.
                                Click
                                on button below to view all Teacher.</p>
                            <a href="{{route('voyager.staff.index')}}" class="btn btn-primary">View all Teachers</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="clearfix container-fluid row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage" style="margin-bottom:0;overflow:hidden;">
                        <div class="dimmer"></div>
                        <div class="panel-content">
                            <i class="voyager-dollar"></i><h4>Student Monthly Fees TK {{ $student_fee }} </h4>
                            <p>You have collected Monthly Fees TK {{ $student_fee }} of Students. Click on button below
                                to
                                view all Student Fees.</p>
                            <a href="{{route('voyager.student-fees.index')}}" class="btn btn-primary">View all Fees</a>
                        </div>
                    </div>
                </div>
                {{-- @endif--}}
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage" style="margin-bottom:0;overflow:hidden;">
                        <div class="dimmer"></div>
                        <div class="panel-content">
                            <i class="voyager-dollar"></i><h4>Monthly Income TK {{$income}}</h4>
                            <p>You have earned this month total TK {{$income}}. Click on button below to view all Income
                                In
                                detail.</p>
                            <a href="{{route('voyager.incomes.index')}}" class="btn btn-primary">View all Income</a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage"
                        ...
                        <div class="panel-content">
                            ...
                            <p>You have
                                total {{\App\Models\Staff::where('library_id', '!=' ,null)->count()+\App\Models\Student::where('library_id', '!=' ,null)->count()}}
                                Library Member in your school. Click on button below to view all Staffs & Student who
                                are
                                library Member.</p>
                            <a href="{{route('staff.add.library')}}" class="btn btn-primary">Staff Membership</a>
                            <a href="{{route('student.add.library')}}" class="btn btn-primary">Student Membership</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="clearfix container-fluid row">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage"
                        ...
                        <div class="dimmer"></div>
                        <div class="panel-content">
                            <i class="voyager-dollar"></i><h4>Monthly Expenses TK {{$expense}}</h4>
                            <p>You have expensed this month total TK {{$expense}}. Click on button below to view all
                                Expenses In detail.</p>
                            <a href="{{route('voyager.expenses.index')}}" class="btn btn-primary">View all Expenses</a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage"
                        ...
                        <div class="panel-content">
                            <i class="voyager-book"></i><h4>{{\App\Models\Book::all()->count()}} Book</h4>
                            <p>You have {{\App\Models\Book::all()->count()}} books in your library. Click on button
                                below to
                                view all Books.</p>
                            <a href="{{route('voyager.books.index')}}" class="btn btn-primary">View all Books</a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage"
                        ...
                        <div class="dimmer"></div>
                        <div class="panel-content">
                            <i class="voyager-dollar"></i><h4>Student Due Fees TK {{$student_due_fee}}</h4>
                            <p>You have total student due fees TK {{$student_due_fee}} for this month. Click on button
                                below
                                to view all due fees.</p>
                            <a href="{{route('studentDueFeesindex')}}" class="btn btn-primary">Due Fees</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="clearfix container-fluid row">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage"
                        ...
                        <div class="dimmer"></div>
                        <div class="panel-content">
                            <i class="voyager-group"></i><h4>Total User {{$user}}</h4>
                            <p>You have total {{$user}} user in your site. Click on button below to view all users In
                                detail.</p>
                            <a href="{{route('voyager.users.index')}}" class="btn btn-primary">View all User</a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage"
                        ...
                        <div class="panel-content">
                            <i class="voyager-group"></i><h4>Today Student Present {{$today_present_student}}</h4>
                            <p>Today total {{$today_present_student}} students are present in your institute. Click on
                                button below to view all present student.</p>
                            <a href="{{route('voyager.student-attendances.index')}}" class="btn btn-primary">View
                                Attendence</a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage"
                        ...
                        <div class="dimmer"></div>
                        <div class="panel-content">
                            <i class="voyager-group"></i><h4>Today Staff Present {{$today_present_staff}}</h4>
                            <p>Today total {{$today_present_staff}} staff are present in your institute. Click on button
                                below to view all present staff.</p>
                            <a href="{{route('voyager.staff-attendances.index')}}" class="btn btn-primary">View
                                Staff</a>
                        </div>
                    </div>
                </div>
