...
@section('content')
    ...
    @foreach($dataTypeContent as $data)
        <div class="modal fade" id="myModal-{{$data->id}}" role="dialog" style="width: 100%; display: none;" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="certificate_detail">
                        ...
                        <div class="" style="position: relative; text-align: center; font-family: 'arial';">
                            <img src="{{ \TCG\Voyager\Facades\Voyager::image($data->logo_image) }}"
                                ...
                                <tr>
                                    <td style="position: absolute;right:0;">
                                        <img style="position: relative; top:230px;"
                                             src="{{ \TCG\Voyager\Facades\Voyager::image($data->student_image) }}" width="100"
                                             height="auto">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td valign="top" style="text-align:right; position: relative; top:360px">{{$data->right_header}}
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" valign="top" style="position: relative;top:400px">
                                        <p style="font-size: 14px; text-align:center;line-height: normal;">{{$data->certificate_text}}</td>
                                </tr>
                                <tr style="">
...
@section('javascript')
    ...
    <script>
        ...
        $('td').on('click', '.certificateModal', function (e) {
            //alert('a');
            $id = $(this).data('modal_id');
            $("#" + $id).modal('show');
        });
