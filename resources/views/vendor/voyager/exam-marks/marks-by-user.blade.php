                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        <div class="alert alert-primary text-center" style="background-color:#ededff">
                            <h4 style="color: #134013"><em><strong>Exam Marks</strong></em></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        <div class="box-header with-border">
                            <h3 class="bold"><i class="fa-solid fa-list"></i> Mark Details</h3>
                        </div>
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="table table-striped" id="dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <th width="20%" style="text-align: center">Subject Name</th>
                                        <th width="30%" style="text-align: center">Exam Type</th>
                                        <th width="20%" style="text-align: center">Obtained Mark</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php $i = 1; ?>
                                    @foreach($student_marks as $mark)
                                        <tr>
                                            ...
                                            <td width="20%" style="text-align: center">{{$mark->student->full_name}}</td>
                                            <td width="20%" style="text-align: center">{{$mark->subject->name}}</td>
                                            <td width="30%" style="text-align: center">{{$mark->examType->name}}</td>
                                            <td width="20%" style="text-align: center">{{$mark->mark}}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
