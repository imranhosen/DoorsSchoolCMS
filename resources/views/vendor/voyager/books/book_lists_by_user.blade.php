                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        <div class="box-header with-border">
                            <h3 class="bold"><i class="fa-solid fa-list"></i> Book Lists</h3>
                        </div>
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="table table-striped" id="dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <th width="10%" style="text-align: center">Quantity Available</th>
                                        <th width="10%" style="text-align: center">Details</th>
                                        <th width="10%" style="text-align: center">Is Available?</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php $i = 1; ?>
                                    @foreach($books as $book)
                                        <tr>
                                            ...
                                            <td width="10%" style="text-align: center">{{$book->book_title}}</td>
                                            <td width="5%" style="text-align: center">{{$book->book_no}}</td>
                                            <td width="10%" style="text-align: center">{{$book->publisher}}</td>
                                            <td width="15%" style="text-align: center">{{$book->author}}</td>
                                            <td width="18%" style="text-align: center">{{$book->subject}}</td>
                                            <td width="10%" style="text-align: center">{{$book->rack_no}}</td>
                                            <td width="10%" style="text-align: center">{{$book->qty}}</td>
                                            <td width="10%" style="text-align: center">{{$book->description}}</td>
